...
export default function VillaShowcase() {
  return (
    <section id="villa" className="py-8 px-4 bg-[#FAF7F2]">
      <div className="max-w-7xl mx-auto">
        <div className="glass-sand rounded-3xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <motion.div
              ...
              className="flex flex-col justify-center px-8 lg:px-10 py-10"
            >
              ...
              <p className="font-body text-[#5C4A3C] text-sm leading-relaxed mb-7">
                EsmaApart'ın taçlı konaklaması. Geniş özel yüzme havuzu ve bakımlı bahçesiyle aileler ve grup tatilleri için ideal.
              </p>

              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-8">
                {features.map((f) => (
                  <li key={f} className="flex items-center gap-2 font-body text-sm text-[#3D3028]">
              ...
              <a
                href="https://wa.me/905383999618?text=Merhaba%2C%20Lüks%20Villa%20için%20rezervasyon%20sorgusu%20yapmak%20istiyorum."
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full bg-[#1B3A2D] hover:bg-[#2D5441] text-white font-body text-sm font-medium tracking-wide shadow-md shadow-[#1B3A2D]/20 hover:shadow-[#1B3A2D]/35 transition-all duration-220 cursor-pointer w-fit"
              >
